...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{retina_matrix.png}
\caption{Confusion matrix for RetinaNet classification.}
\label{fig:retina_cm}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{retina-box1.jpg}
\caption{Examples of RetinaNet predictions on validation images.}
\label{fig:retina_examples}
\end{figure}
