...
\section{Discussion}
The models showed similar limitations when detecting mammographic lesions, especially calcifications. Masses were generally easier to detect and classify.

Faster R-CNN provided interpretable results through separate detection and classification metrics, while YOLO offered a stronger standard object detection benchmark through mAP evaluation.

YOLO achieved an overall mAP@0.5 of 0.355, while Faster R-CNN reached a detection precision of 0.3846 and recall of 0.4167. Although the metrics are not directly identical, both models demonstrated moderate performance and difficulties with small lesions.

The main challenge in both approaches was the calcification class, which consistently obtained lower performance than masses.
